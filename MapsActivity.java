...
public class MapsActivity<S, U> extends AppCompatActivity
    ...
    private final LatLng mRetrieved = new LatLng(41.3851, 2.1734);
    ...
    private void getDeviceLocation() {
        ...
        //If the maps has been called from MainActivity -> FindMybeacon button
           ...
           databaseReference = FirebaseDatabase.getInstance().getReference().child( "foo" ).child( "04:69:F8:9E:74:CA" );
